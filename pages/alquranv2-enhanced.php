        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="text-xl md:text-2xl text-green-100 mb-6">
                    Baca dan dengarkan Al-Quran dengan fitur canggih
                </p>
                <div class="flex flex-wrap justify-center gap-4 text-sm">
                    ...
                    <div class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                        <i class="fas fa-volume-up mr-2"></i>Audio HD
                    </div>
                    <div class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                        <i class="fas fa-language mr-2"></i>Terjemahan
                    </div>
                    <div class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                ...
                <div class="flex-1 relative">
                    <div class="relative">
                        <input type="text" 
                               ...
                               class="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    ...
                    <!-- Search suggestions -->
                    <div id="searchSuggestions" class="absolute z-10 w-full bg-white border border-gray-200 rounded-lg shadow-lg mt-1 hidden max-h-60 overflow-y-auto"></div>
                </div>
