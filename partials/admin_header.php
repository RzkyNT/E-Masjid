...
<head>
    ...
    <!-- Quill.js CSS for rich text editor (if needed) -->
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="hidden md:flex items-center space-x-2">
                        <a href="../../index.php" target="_blank" class="text-gray-500 hover:text-green-600 text-sm">
        ...
        <main class="flex-1 main-content content-with-sidebar">
            <div class="p-6">
                ...
                <div class="mb-6 flex justify-between items-center">
                    <div class="hidden md:flex items-center space-x-2">
                        <a href="../../pages/gsg.php" target="_blank" class="text-blue-600 hover:text-blue-800 text-sm">
