...
<div id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-800 transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:inset-0">
    ...
    <div class="flex items-center justify-between h-16 px-4 bg-gray-900">
        <div class="flex items-center">
            ...
            <div class="ml-3 sidebar-text">
                <h1 class="text-lg font-semibold text-white">Bimbel Al-Muhajirin</h1>
    ...
    <nav class="mt-5 px-2 space-y-1">
        ...
        <!-- Back to Masjid Admin -->
        <a href="../masjid/dashboard.php"
        class="text-gray-300 hover:bg-gray-700 hover:text-white
                group flex items-center px-2 py-2 text-sm font-medium rounded-md transition-colors duration-200">
            <i class="fas fa-mosque mr-3 flex-shrink-0 h-5 w-5"></i>
            <span class="sidebar-text">Admin Masjid</span>
        </a>
    </nav>
...
<!-- Include the same styles and scripts as the main admin sidebar -->
<style>
