...
- [ ] 2. Create shared layout and navigation system
  - [ ] 2.1 Build responsive header and navigation
  ...
  - [ ] 2.2 Create footer and shared components
...
- [ ] 3. Implement homepage and core public pages
  ...
  - [ ] 3.3 Create kontak page with form functionality
    ...
    - Add form submission confirmation and email notification
    - _Requirements: 7.1, 7.2, 7.3, 7.4_

- [ ] 4. Implement prayer schedule system
  - [ ] 4.1 Create prayer schedule display and API integration
...
- [ ] 5. Build news and article management system
  - [ ] 5.1 Create public news display pages
  ...
  - [ ] 5.2 Implement admin news management interface
  ...
  - [ ] 5.3 Add article SEO and publishing features
...
- [ ] 6. Create gallery system with media management
  - [ ] 6.1 Build public gallery display
    - Create galeri.php with responsive photo grid and lightbox functionality
...
- [ ] 7. Implement donation information system
  - [ ] 7.1 Create donation information page
  ...
  - [ ] 7.2 Add donation reporting and transparency features
...
- [ ] 8. Add content management and settings system
  - [ ] 8.1 Create admin dashboard and overview
